...
export default function SettingsModal() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
      <div className="relative flex w-full flex-col overflow-hidden bg-studio-content text-studio-text-primary shadow-2xl md:w-[700px] md:flex-row border border-white/10 rounded-2xl h-[85vh] max-h-[600px]">
        <button
