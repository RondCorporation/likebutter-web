...
export default function ButterArtPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl">
      <h2 className="mb-2 text-xl font-semibold">Create with Butter Art</h2>
      <p className="mb-8 text-slate-400">
        그리고 싶은 팬아트를 텍스트로 묘사하거나, 직접 그린 스케치를 업로드하여
        AI와 함께 완성해보세요.
      </p>
      ...
      <div className="mb-6">
        ...
        <textarea
          ...
          placeholder="e.g., A watercolor painting of V from BTS in a field of purple flowers, impressionistic style..."
          rows={4}
