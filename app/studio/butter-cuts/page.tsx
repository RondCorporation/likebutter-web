...
export default function ButterCutsPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl">
      <h2 className="mb-2 text-xl font-semibold">Edit with Butter Cuts</h2>
      <p className="mb-8 text-slate-400">
        당신의 감정이 담긴 텍스트를 입력하거나, 이미지, 동영상을 업로드하여
        감각적인 영상을 생성해보세요.
      </p>
      ...
      <div className="mb-6">
        ...
        <textarea
          ...
          placeholder="e.g., A nostalgic and dreamy edit with slow motion, add soft light leaks..."
          rows={3}
      ...
      <div className="mb-8">
        ...
        <div className="relative flex min-h-40 w-full flex-col items-center justify-center rounded-lg border-2 border-dashed border-white/20 bg-white/5 p-4 text-slate-400 transition-colors hover:border-accent/50 hover:text-accent">
          ...
          {uploadedFiles.length > 0 ? (
            ...
            <p>Click to browse or drag & drop your media</p>
          )}
          <input
            type="file"
            accept="image/*,video/*"
